...
define('VEGETABLEPATH', 'assets'.DIRECTORY_SEPARATOR.'images'.DIRECTORY_SEPARATOR.'vegetables'.DIRECTORY_SEPARATOR);
define('FRUITPATH', 'assets'.DIRECTORY_SEPARATOR.'images'.DIRECTORY_SEPARATOR.'fruits'.DIRECTORY_SEPARATOR);
